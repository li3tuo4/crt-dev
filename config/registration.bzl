...
load("@crt//toolchains/lowrisc_rv64imac:repository.bzl", "lowrisc_rv64imac_repos")
...
def crt_register_toolchains(
    ...
    if riscv64:
        lowrisc_rv64imac_repos(local = _maybe_archive(riscv64))
        native.register_execution_platforms("@crt//platforms/riscv64:all")
        native.register_toolchains("@crt//toolchains/lowrisc_rv64imac:all")
